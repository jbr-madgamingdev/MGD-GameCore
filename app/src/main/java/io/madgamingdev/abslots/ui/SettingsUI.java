...
public class SettingsUI extends AppCompatActivity {
    ...
    private void showLocationPermissionRationaleDialog() {
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Grant", (dialog, which) -> ActivityCompat.requestPermissions(SettingsUI.this,
                        new String[]{Manifest.permission.ACCESS_FINE_LOCATION},
                        MY_LOCATION_PERMISSION_REQUEST))
                .setNegativeButton("Deny", (dialog, which) -> Toast.makeText(SettingsUI.this, "Location permission denied", Toast.LENGTH_SHORT).show())
                .show();
    }
    ...
    /**
     * @param requestCode  The request code passed in {@link io.madgamingdev.abslots.ui.SettingsUI #requestPermissions(
